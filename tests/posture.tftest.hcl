...
mock_provider "aws" {
  mock_data "aws_secretsmanager_secret_version" {
    defaults = {
      secret_string = "{\"keycloak_admin_user\": \"e2e-test-keycloak_admin_user\", \"keycloak_admin_user_password\": \"e2e-test-keycloak_admin_user_password\", \"keycloak_password\": \"e2e-test-keycloak_password\", \"keycloak_username\": \"e2e-test-keycloak_username\"}"
    }
  }
